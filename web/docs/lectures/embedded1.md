...
Slides courses are available [here](embedded1/img/cours1-embedded.pdf)
...
Here is an example of a teensy program using a Makefile rather than the arduino environment for compilation: 
 - Download the teensy_makefile project [here](embedded1/img/teensy_makefile.tar)
...
The generic ``Makefile`` that you can use for your project is here <!--[is here](embedded1/img/Makefile)-->.
